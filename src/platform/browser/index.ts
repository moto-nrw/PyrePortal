...
class BrowserAdapter implements PlatformAdapter {
  ...
  async saveSessionSettings(_settings: SessionSettings): Promise<void> {
    throw new Error('BrowserAdapter.saveSessionSettings not implemented yet');
  }

  async loadSessionSettings(): Promise<SessionSettings | null> {
    throw new Error('BrowserAdapter.loadSessionSettings not implemented yet');
  }

  async clearLastSession(): Promise<void> {
    throw new Error('BrowserAdapter.clearLastSession not implemented yet');
  }
